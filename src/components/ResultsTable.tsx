      ...
      {isPartial && (
        <div className="bg-amber-50 border-b border-amber-200 px-6 py-3 flex items-center gap-3">
          ...
          <p className="text-sm text-amber-800">
            <span className="font-semibold">Aviso:</span> Devido ao grande volume de dados, a extração de e-mails foi interrompida para evitar timeout. Os dados básicos estão completos.
          </p>
        </div>
      )}
